...
clear script - отчистить script 


# КАК УСТАНОВИТЬ?? 

1. Скачиваете репозиторий
2. Собираете по очереди два проекта.

# ПРОБЛЕМЫ С CMAKE НЕ НАХОДИТ Qt5? 
в CMakeLists.txt есть в закомментрованные строчки с path, пропишите туда свой 
